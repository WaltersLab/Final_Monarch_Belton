...
save_output(
  ...
  "Parametric Model Comparison (Text Version)",
  stats_file
)
```
...
jpeg("../Results/Parametric_Monarch/Figures/Figure_01_gompertz_and_weibull_plots.png", width = 90, height = 150, units = "mm", res=150)
...
```{r}
ggsave(
  filename = "../Results/Parametric_Monarch/Figures/Figure_02_smoothedhazard.jpg",
  plot = smoothedhazard,
  width = 180,    
  height = 120,
  units = "mm",
...
```{r}
ggsave(
  filename = "../Results/Parametric_Monarch/Figures/Figure_03_predicted_vs_smoothed_hazard.jpg",
